...
export const myProjects = [
    {
        title: 'Chat App',
        desc: 'Aplicación web de chat en tiempo real que permite a los usuarios comunicarse de manera instantánea y fluida usando una API hecha con express.',
        subdesc:
    ...
    {
        title: 'Movie App',
        desc: 'Una aplicación web de películas que permite a los usuarios explorar y descubrir películas populares, ver detalles, calificaciones y trailers.',
        subdesc:
    ...
    },
    {
        ...
        desc: 'Aplicación web de calculadora que permite a los usuarios realizar operaciones matemáticas básicas y avanzadas de manera intuitiva.',
        subdesc:
